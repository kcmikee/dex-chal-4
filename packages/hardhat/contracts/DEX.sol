...
contract DEX {
	...
	function init(uint256 tokens) public payable returns (uint256) {
		...
		require (token.transferFrom(msg.sender, address(this), tokens), "Sender doesn't have enough token");
  ...
  function tokenToEth(uint256 tokenInput) public returns (uint256 ethOutput) {
	...
	function withdraw(
		...
		require(liquidity[msg.sender] >= amount, "Withdraw: sender doesn't have enough liquidityh to withdraw");
